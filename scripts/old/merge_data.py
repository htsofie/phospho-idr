...
def main():
    ...
    df_enhanced = pd.read_parquet("../data/processed/mouse/cleaned_phosphomouse_site_data.parquet")
    df_sequences = pd.read_parquet("../data/processed/mouse/cleaned_phosphorylation_sites_with_sequences.parquet")
    ...
    # Save merged data
    output_file = "../data/processed/mouse/cleaned_phosphomouse_complete.parquet"
