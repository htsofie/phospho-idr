...
df = pd.read_parquet("data/processed/mouse/Phosphomouse_phosphorylation_sites.parquet")
...
output_file = "data/processed/mouse/cleaned_phosphomouse_site_data.parquet"
