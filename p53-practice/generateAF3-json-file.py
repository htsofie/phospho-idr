...
def extract_sequences_from_tsv(tsv_file_path, output_dir="."):
    """
    ...
    Args:
        ...
        output_dir (str): Directory to save the sequence files (defaults to current directory)
    """
    
    # Create output directory if it doesn't exist (only if it's not the current directory)
    if output_dir != ".":
